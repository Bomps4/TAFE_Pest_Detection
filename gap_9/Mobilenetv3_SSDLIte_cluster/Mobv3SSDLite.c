...
void write_outputs() {
    ...
    File_Output_1 = __OPEN_WRITE(fs, "../Output_1.bin");
    #endif
    ret_Output_1 = __WRITE(File_Output_1, Output_1, 2574*sizeof(signed char));
    ...
    File_Output_2 = __OPEN_WRITE(fs, "../Output_2.bin");
    #endif
    ret_Output_2 = __WRITE(File_Output_2, Output_2, 2574*sizeof(signed char));
    ...
    File_Output_3 = __OPEN_WRITE(fs, "../Output_3.bin");
    #endif
    ret_Output_3 = __WRITE(File_Output_3, Output_3, 2574*sizeof(signed char));
    ...
    File_Output_4 = __OPEN_WRITE(fs, "../Output_4.bin");
    #endif
    ret_Output_4 = __WRITE(File_Output_4, Output_4, 2574*sizeof(signed char));
